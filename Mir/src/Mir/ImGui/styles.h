...
namespace Mir {
    ...
    inline Style g_Styles[] = {
        ...
        { "Tatu Steam", ApplyTatuSteamStyle }
    };
    ...
    inline void ApplyTatuSteamStyle() {
        ImVec4* colors = ImGui::GetStyle().Colors;
        colors[ImGuiCol_Text]                   = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
        colors[ImGuiCol_TextDisabled]           = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
        colors[ImGuiCol_WindowBg]               = ImVec4(0.11f, 0.13f, 0.10f, 0.44f);
        colors[ImGuiCol_ChildBg]                = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        colors[ImGuiCol_PopupBg]                = ImVec4(0.08f, 0.08f, 0.08f, 0.94f);
        colors[ImGuiCol_Border]                 = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
        colors[ImGuiCol_BorderShadow]           = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        colors[ImGuiCol_FrameBg]                = ImVec4(0.30f, 0.35f, 0.27f, 0.54f);
        colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.98f, 0.65f, 0.26f, 0.40f);
        colors[ImGuiCol_FrameBgActive]          = ImVec4(0.98f, 0.65f, 0.26f, 0.67f);
        colors[ImGuiCol_TitleBg]                = ImVec4(0.30f, 0.40f, 0.23f, 1.00f);
        ...
        colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4(0.41f, 0.41f, 0.41f, 1.00f);
        colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4(0.51f, 0.51f, 0.51f, 1.00f);
        colors[ImGuiCol_CheckMark]              = ImVec4(0.44f, 0.51f, 0.39f, 1.00f);
        colors[ImGuiCol_SliderGrab]             = ImVec4(0.44f, 0.51f, 0.39f, 1.00f);
        colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.44f, 0.51f, 0.39f, 1.00f);
        colors[ImGuiCol_Button]                 = ImVec4(0.30f, 0.35f, 0.27f, 1.00f);
        colors[ImGuiCol_ButtonHovered]          = ImVec4(0.42f, 0.49f, 0.38f, 1.00f);
        colors[ImGuiCol_ButtonActive]           = ImVec4(0.25f, 0.35f, 0.18f, 1.00f);
        colors[ImGuiCol_Header]                 = ImVec4(0.30f, 0.35f, 0.27f, 0.89f);
        colors[ImGuiCol_HeaderHovered]          = ImVec4(0.25f, 0.35f, 0.18f, 1.00f);
        colors[ImGuiCol_HeaderActive]           = ImVec4(0.43f, 0.50f, 0.38f, 1.00f);
        colors[ImGuiCol_Separator]              = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
        colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.28f, 0.34f, 0.23f, 0.83f);
        colors[ImGuiCol_SeparatorActive]        = ImVec4(0.28f, 0.35f, 0.24f, 1.00f);
        colors[ImGuiCol_ResizeGrip]             = ImVec4(0.98f, 0.65f, 0.26f, 0.20f);
        colors[ImGuiCol_ResizeGripHovered]      = ImVec4(0.98f, 0.65f, 0.26f, 0.67f);
        colors[ImGuiCol_ResizeGripActive]       = ImVec4(0.98f, 0.65f, 0.26f, 0.95f);
        colors[ImGuiCol_InputTextCursor]        = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
        colors[ImGuiCol_TabHovered]             = ImVec4(0.42f, 0.49f, 0.38f, 0.80f);
        colors[ImGuiCol_Tab]                    = ImVec4(0.30f, 0.35f, 0.27f, 1.00f);
        colors[ImGuiCol_TabSelected]            = ImVec4(0.48f, 0.64f, 0.38f, 1.00f);
        colors[ImGuiCol_TabSelectedOverline]    = ImVec4(0.54f, 0.62f, 0.48f, 1.00f);
        colors[ImGuiCol_TabDimmed]              = ImVec4(0.15f, 0.17f, 0.13f, 1.00f);
        colors[ImGuiCol_TabDimmedSelected]      = ImVec4(0.24f, 0.35f, 0.18f, 1.00f);
        colors[ImGuiCol_TabDimmedSelectedOverline]  = ImVec4(0.50f, 0.50f, 0.50f, 0.00f);
        colors[ImGuiCol_DockingPreview]         = ImVec4(0.30f, 0.35f, 0.27f, 0.70f);
        colors[ImGuiCol_DockingEmptyBg]         = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
        colors[ImGuiCol_PlotLines]              = ImVec4(0.61f, 0.61f, 0.61f, 1.00f);
        colors[ImGuiCol_PlotLinesHovered]       = ImVec4(1.00f, 0.43f, 0.35f, 1.00f);
        colors[ImGuiCol_PlotHistogram]          = ImVec4(0.90f, 0.70f, 0.00f, 1.00f);
